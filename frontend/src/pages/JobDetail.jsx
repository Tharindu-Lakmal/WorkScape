        ...
        <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md'>
          <div className='w-full flex items-center justify-between'>
            <div className='w-3/4 flex gap-2'>
              <img
                ...
                className='min-w-20 min-h-20 md:w-24 md:h-20 rounded'
              />
          ...
          <div className='w-full flex flex-wrap md:flex-row gap-2 items-center justify-between my-10'>
            <div className='bg-[#bdf4c8] w-40 h-16 rounded-lg flex flex-col items-center justify-center'>
              <span className='text-sm text-bdDarkGray'>Salary</span>
              <p className='text-lg font-semibold text-bdDarkGray'>
                $ {job?.salary}
              </p>
            </div>

            <div className='bg-[#bae5f4] w-40 h-16 rounded-lg flex flex-col items-center justify-center'>
              <span className='text-sm text-bdDarkGray'>Job Type</span>
              <p className='text-lg font-semibold text-bdDarkGray'>
                {job?.jobType}
              </p>
            </div>
            ...
            <div className='bg-[#fed0ab] w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center'>
              <span className='text-sm text-bdDarkGray'>No. of Applicants</span>
              <p className='text-lg font-semibold text-bdDarkGray'>
            ...
            <div className='bg-[#cecdff] w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center'>
              <span className='text-sm text-bdDarkGray'>No. of Vacancies</span>
              <p className='text-lg font-semibold text-bdDarkGray'>
                {job?.vacancies}
              </p>
            </div>
          ...
          <div className='w-full'>
            <CustomButton
              title='Apply Now'
              containerStyles={`w-full lg:w-fill flex items-center justify-center text-white bg-brightBlue-100 py-3 px-5 outline-none rounded-full text-base`}
            />
          </div>
        </div>
